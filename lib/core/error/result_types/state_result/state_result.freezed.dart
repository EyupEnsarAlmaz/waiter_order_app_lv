...
abstract class $StateResultCopyWith<T, $Res> {
  factory $StateResultCopyWith(
      ...
      _$StateResultCopyWithImpl<T, $Res, StateResult<T>>;
}

/// @nodoc
class _$StateResultCopyWithImpl<T, $Res, $Val extends StateResult<T>>
...
class __$$InitialImplCopyWithImpl<T, $Res>
    extends _$StateResultCopyWithImpl<T, $Res, _$InitialImpl<T>>
...
class __$$LoadingImplCopyWithImpl<T, $Res>
    extends _$StateResultCopyWithImpl<T, $Res, _$LoadingImpl<T>>
...
class __$$CompletedImplCopyWithImpl<T, $Res>
    extends _$StateResultCopyWithImpl<T, $Res, _$CompletedImpl<T>>
...
class __$$FailedImplCopyWithImpl<T, $Res>
    extends _$StateResultCopyWithImpl<T, $Res, _$FailedImpl<T>>
...
abstract class Failed<T> implements StateResult<T> {
  const factory Failed(final CustomFailure failure) = _$FailedImpl<T>;
